  ...
  return (
    <>
      ...
      >
        ...
        <span className="group-hover:opacity-100 opacity-0 group-hover:duration-1000 duration-100 z-10  absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
          {children}
        </span>
      </button>
    </>
